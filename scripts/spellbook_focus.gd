...
func _process(delta):
    ...
    if rune_light != null:
        rune_light.light_energy = 1.25 + sin(float_time * 4.2) * 0.18 + attack_push * 2.2
        rune_light.omni_range = 3.2 + attack_push * 1.4
...
func _spawn_light():
    ...
    rune_light.light_energy = 1.25
    rune_light.omni_range = 3.2
